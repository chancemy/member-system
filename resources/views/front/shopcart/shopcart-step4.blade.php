...
<main>
    <div class="cart-container">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-6 d-flex justify-content-end align-items-center">
                            <div class="item-quantiys d-flex justify-content-between">
                                ...
                                <div class="price d-flex align-items-center ml-3 ">$<span
                                        id="burrito-price">{{ $detail->qty * $product->product_price }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-2">
                                    ...
                                    <div class="items-price d-flex justify-content-between align-items-center">
                                        <span>小計:</span>
                                        <div class="value ml-3" id="items-price">{{  $order->price  }}</div>
                                    </div>
                                    ...
                                    <div class="to-price d-flex justify-content-between align-items-center">
                                        <span>總計:</span>
                                        <div class="value ml-3" id="total-price">
                                            {{  $order->price +  $order->shipping_fee}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="opctions d-flex justify-content-between align-items-center">
            <a href="{{ asset('/') }}" class="btn btn-primary" type="submit"> 反回首頁</a>
        </div>
    </div>
</main>
@endsection
