  ...
  <nav>
    <div class="container custom-container-width " style="padding: 0px 32px ;">
      <nav class="navbar navbar-expand-md navbar-light p-0" style="height: 92px;">
        <a class="navbar-brand m-0" style="padding: 16px;" href="#">
        ...
        <div class="collapse navbar-collapse" style="height: 52px;" id="navbarSupportedContent">
          ...
          <ul class="link-icon d-flex m-0 p-0">
            <li class="nav-item d-flex justify-content-center align-items-center " >
              <a class="nav-link text-dark text-md-left text-right p-0" href="{{ asset('step1') }}"><i class="fas fa-shopping-cart" style="font-size: 24px; margin-left: 8px; padding: 8px 4px; line-height: 1.25rem;"></i></a>
            </li>
            <li class="nav-item d-flex justify-content-center align-items-center ">
              <div class="btn-account nav-link text-dark text-md-left text-sm-left p-0" ><i class="fas fa-user-circle"style="font-size: 30px;  margin-left: 16px; padding: 8px 4px; line-height: 1.25rem;"></i></div>
